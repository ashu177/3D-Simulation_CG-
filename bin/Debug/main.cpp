...
static void resize(int width, int height)
{
    ...
    glLoadIdentity();
    glFrustum(-ar, ar,-1.0, 2.0, 1.0, 100.0);
...
void renderScene(void) {
    ...
    glPushMatrix();
        ...
        glTranslatef(0,0,-10);
        glBegin(GL_QUADS);
            glTexCoord3f(0.0,1.0,0.1);  glVertex3f(-40,40,-6);
            glTexCoord3f(1.0,1.0,0.1);  glVertex3f(40,40,-6);
            glTexCoord3f(1.0,0.0,0.1);  glVertex3f(40,-40,-6);
            glTexCoord3f(0.0,0.0,0.1);  glVertex3f(-40,-40,-6);
        glEnd();
    glPopMatrix();
    ...
    glPushMatrix();
        ...
        // Wall
            ...
            glTexCoord3f(0.0,2.0,0.1);  glVertex3f(-5,0,9);
            glTexCoord3f(4.0,2.0,0.1);  glVertex3f(5,0,9);
            glTexCoord3f(4.0,0.0,0.1);  glVertex3f(5,-1.5,9);
            glTexCoord3f(0.0,0.0,0.1);  glVertex3f(-5,-1.5,9);
        glEnd();
...
/*
            ...
            glTexCoord3f(100.0,2.0,0);glVertex3f(2.2,0.5,0);
    ...
    glPushMatrix();
        ...
        glBegin(GL_QUADS);  // Wall
            glTexCoord3f(0.0,2.0,-1);  glVertex3f(-5,0,-1);
            glTexCoord3f(4.0,2.0,-1);  glVertex3f(5,0,-1);
            glTexCoord3f(4.0,0.0,-1);  glVertex3f(5,-1.5,-1);
            glTexCoord3f(0.0,0.0,-1);  glVertex3f(-5,-1.5,-1);
        glEnd();
...
*/
    ...
    glPushMatrix();
        ...
        glRotatef(_angle, 0.0, 1.0, 0.0);
        glBegin(GL_QUADS);  // Wall
            glTexCoord3f(0.0,2.0,1); glVertex3f(5,0,10);
            glTexCoord3f(2.0,2.0,-1); glVertex3f(5,0,-1);
            glTexCoord3f(2.0,0.0,-1); glVertex3f(5,-1.5,-1);
            glTexCoord3f(0.0,0.0,1); glVertex3f(5,-1.5,10);
        glEnd();
    ...
    glPushMatrix();
        ...
        // Wall
            ...
            glTexCoord3f(0.0,2.0,0.1);  glVertex3f(-5,3,9);
            glTexCoord3f(4.0,2.0,0.1);  glVertex3f(5,3,9);
            glTexCoord3f(4.0,0.0,0.1);  glVertex3f(5,1.5,9);
            glTexCoord3f(0.0,0.0,0.1);  glVertex3f(-5,1.5,9);
        glEnd();
    glPopMatrix();
    ...
    //First Floor BACK
     glPushMatrix();
        ...
        glRotatef(_angle, 0.0, 1.0, 0.0);
        glBegin(GL_QUADS);  // Wall
            glTexCoord3f(0.0,2.0,-1);  glVertex3f(-5,3,-1);
            glTexCoord3f(4.0,2.0,-1);  glVertex3f(5,3,-1);
            glTexCoord3f(4.0,0.0,-1);  glVertex3f(5,1.5,-1);
            glTexCoord3f(0.0,0.0,-1);  glVertex3f(-5,1.5,-1);
        glEnd();
    glPopMatrix();
    ...
    glPushMatrix();
        ...
        glRotatef(_angle, 0.0, 1.0, 0.0);
        glBegin(GL_QUADS);  // Wall
            glTexCoord3f(0.0,2.0,1); glVertex3f(5,3,10);
            glTexCoord3f(2.0,2.0,-1); glVertex3f(5,3,-1);
            glTexCoord3f(2.0,0.0,-1); glVertex3f(5,1.5,-1);
            glTexCoord3f(0.0,0.0,1); glVertex3f(5,1.5,10);
        glEnd();
    glPopMatrix();
...
void Initialize() {
	...
	Image* image = loadBMP("C:\\Users\\dell pc\\Documents\\te\\bin\\Debug\\bricks.bmp");
	_textureBrick = loadTexture(image);
	image = loadBMP("C:\\Users\\dell pc\\Documents\\te\\door.bmp");
	_textureDoor = loadTexture(image);
	image = loadBMP("C:\\Users\\dell pc\\Documents\\te\\grass.bmp");
	_textureGrass = loadTexture(image);
	image = loadBMP("C:\\Users\\dell pc\\Documents\\te\\roof.bmp");
	_textureRoof = loadTexture(image);
	image = loadBMP("C:\\Users\\dell pc\\Documents\\te\\window.bmp");
	_textureWindow = loadTexture(image);
	image = loadBMP("C:\\Users\\dell pc\\Documents\\te\\sky.bmp");
...
int main(int argc, char **argv) {
	...
	glutCreateWindow("Textured Building by ASHU");
